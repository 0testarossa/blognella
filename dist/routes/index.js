...
router.get('/layouts', layoutController_1.getLayouts);
router.get('/layout/:id', layoutController_1.getLayout);
router.post('/layout', layoutController_1.addLayout);
router.put('/layout/:id', layoutController_1.updateLayout);
router.delete('/layout/:id', layoutController_1.deleteLayout);
